...
(Source: [In depth: Parameter tuning for SVM](https://medium.com/all-things-ai/in-depth-parameter-tuning-for-svc-758215394769) )
...
<img src="https://github.com/Insignite/SVM-Food101-Classification/blob/master/img/grid_search.PNG" height="70%" width="70%">

After 396 cross validations run with different parameters, the parameter with highest accuracy is Kernel = Linear, 
